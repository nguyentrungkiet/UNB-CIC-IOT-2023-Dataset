...
output_folder = 'D:\\SourceCode\\CICIoT2023_v4\\8_nhan\\lstm\\bieudo_ketqua'
...
# We'll treat each feature vector as a single time step
...
# 3. Learning curves from LSTM training history (replaces feature importance)
...
plt.tight_layout()
plt.savefig(os.path.join(output_folder, 'lstm_learning_curves.png'))
plt.close()
...
plt.title('Learning Curves - LSTM Accuracy', fontsize=16)
